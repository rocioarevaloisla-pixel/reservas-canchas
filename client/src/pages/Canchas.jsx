...
export default function Canchas() {
  ...
  const [form, setForm] = useState({ nombre: '', descripcion: '', precioPorHora: '', capacidad: '' });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm({ nombre: '', descripcion: '', precioPorHora: '', capacidad: '' });
      setEditId(null);
      load();
    } catch (err) {
        ...
        <div className="table-wrapper">
          <table className="table">
            ...
            <tbody>
              ...
              {list.length === 0 && (
                <tr className="table-empty"><td colSpan="5">
